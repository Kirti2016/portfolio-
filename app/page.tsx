        ...
        <div className="mx-auto max-w-5xl px-4 grid gap-10 md:grid-cols-2 items-center">
          ...
          <RevealOnScroll delay={120}>
            <div className="mx-auto w-full max-w-sm">
              ...
              <div className="animate-float glass-panel mt-4 inline-block rounded-full px-3 py-1 text-xs text-white/80">
                Available for work
              </div>
            </div>
          </RevealOnScroll>
    ...
    <div className="space-y-12 max-w-4xl mx-auto font-sans text-white/90">
      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="space-y-2 max-w-md md:max-w-lg">
          <h4 className="text-2xl font-semibold font-heading text-gradient-cyan">Summer Internship – AICTE IDEALab (June–Aug 2025)</h4>
      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        />
        <div className="space-y-2 max-w-md md:max-w-lg">
          <h4 className="text-2xl font-semibold font-heading text-gradient-cyan">Participation – Smart India Hackathon 2024 (SIH’24)</h4>
          <p className="text-base leading-relaxed">
